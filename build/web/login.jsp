...
<body>
    <div id="logreg-forms">
        <form class="form-signin" action="login" method="post">
            ...
            <input name="user" value="${param.user}" type="email" id="inputEmail" class="form-control" placeholder="Email address" required="" autofocus="">
            ...
            <form action="signup" method="post" class="form-signup">
                ...
                <input type="text" name="fullname" id="user-name" class="form-control" placeholder="Full name" required="" autofocus="">
